...
@section('body')
<form action="{{ route('pekerjaan-simpan') }}" method="POST">
    @csrf
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" aria-describedby="basic-addon13" id="pendapatanterakhir" name="pendapatanterakhir" >
                        </div>
                        <div class="input-group">
