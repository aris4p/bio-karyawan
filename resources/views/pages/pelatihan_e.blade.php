...
@section('body')
<form action="{{ route('pelatihan-simpan') }}" method="POST">
    @csrf
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <div class="input-group">
                            <label class="form-label mt-4" for="basic-default-password32">Nama Pelatihan/kursus</label>
                            <input type="text" class="form-control" aria-describedby="basic-addon13" id="namapelatihan" name="namapelatihan">
                        </div>
                        <div class="input-group">
