                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control"  aria-describedby="basic-addon13" id="institusi" name="institusi" value="{{ optional(auth()->user()->pendidikan)->institusi }}">
                        </div>
                        <div class="input-group">
                            <label class="form-label mt-4" for="basic-default-password32">Jurusan</label>
                            <input type="text" class="form-control"  aria-describedby="basic-addon13" id="jurusan" name="jurusan" value="{{ optional(auth()->user()->pendidikan)->jurusan }}">
                        </div>
                        <div class="input-group">
                            <label class="form-label mt-4" for="basic-default-password32">Tahun Lulus</label>
                            <input type="text" class="form-control"  aria-describedby="basic-addon13" id="tahun" name="tahun" value="{{ optional(auth()->user()->pendidikan)->tahun }}">
                        </div>
                        <div class="input-group">
                            <label class="form-label mt-4" for="basic-default-password32">IPK</label>
                            <input type="text" class="form-control"  aria-describedby="basic-addon13" id="ipk" name="ipk" value="{{ optional(auth()->user()->pendidikan)->ipk }}">
                        </div>
